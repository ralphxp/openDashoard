// Auto-generated from email/read-email.html
// Route: /email/read-email
            ...
            <div class="card card-body overflow-hidden mail-wrapper p-0">
              ...
              <div class="mail-sidebar bg-light">
                ...
                <div class="d-grid gap-2 p-2 mail-nav" id="myTab" role="tablist" data-simplebar>
                  ...
                  <a href="/calendar" class="mail-nav-item">
              ...
              <div class="mail-body">
                <div class="mail-header">
                  <div class="d-flex gap-3">
                    ...
                    <div class="me-2">
                      <a href="/email/inbox" class="btn btn-white btn-shadow btn-icon waves-effect me-2">
                    ...
                    <div class="p-3 bg-light rounded-2">
                      <div class="row g-2">
                        <div class="col-xxl-4 col-md-6">
                          <div class="d-flex gap-3 p-3 rounded-2 align-items-center bg-body">
                            <div class="avatar bg-body rounded-3">
                              <img src="../../..//assets/images/media/svg/media3.svg" alt="">
                            </div>
                            <div class="clearfix">
                        ...
                        <div class="col-xxl-4 col-md-6">
                          <div class="d-flex gap-3 p-3 rounded-2 align-items-center bg-body">
                            <div class="avatar bg-body rounded-3 border">
                              <img src="../../..//assets/images/media/svg/media4.svg" alt="">
                            </div>
                            <div class="clearfix">
                        ...
                        <div class="col-xxl-4 col-md-6">
                          <div class="d-flex gap-3 p-3 rounded-2 align-items-center bg-body">
                            <div class="avatar bg-body rounded-3">
                              <img src="../../..//assets/images/media/svg/media5.svg" alt="">
                            </div>
                            <div class="clearfix">
                        ...
                        <div class="col-xxl-4 col-md-6">
                          <div class="d-flex gap-3 p-3 rounded-2 align-items-center bg-body">
                            <div class="avatar bg-body rounded-3">
                              <img src="../../..//assets/images/media/svg/media6.svg" alt="">
                            </div>
                            <div class="clearfix">
