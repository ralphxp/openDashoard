// Auto-generated from review.html
// Route: /review
    ...
    <main class="app-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xxl-6">
            <div class="card">
              <div class="card-header border-0 pb-0 d-flex flex-wrap gap-3 align-items-center justify-content-between">
                <h6 class="card-title mb-0">Review Trends</h6>
                <ul class="nav nav-pills nav-pills-custom nav-fill p-1 bg-light rounded-5" id="chartReviewTrendTabs" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-5" id="todayReviewTrendTab" data-bs-toggle="tab" type="button" role="tab" aria-selected="false" tabindex="-1">
                      Today
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-5" id="weekReviewTrendTab" data-bs-toggle="tab" type="button" role="tab" aria-selected="false" tabindex="-1">
                      Week
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active rounded-5" id="monthReviewTrendTab" data-bs-toggle="tab" type="button" role="tab" aria-selected="true">
                      Month
                    </button>
                  </li>
                </ul>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="d-flex align-items-center gap-3 mb-2">
                  ...
                  <div class="progress mb-0  w-100" role="progressbar" aria-label="Basic example" aria-valuenow="69.8" aria-valuemin="0" aria-valuemax="100">
                ...
                <div class="d-flex align-items-center gap-3 mb-2">
                  ...
                  <div class="progress mb-0  w-100" role="progressbar" aria-label="Basic example" aria-valuenow="18.5" aria-valuemin="0" aria-valuemax="100">
                ...
                <div class="d-flex align-items-center gap-3 mb-2">
                  ...
                  <div class="progress mb-0  w-100" role="progressbar" aria-label="Basic example" aria-valuenow="5.5" aria-valuemin="0" aria-valuemax="100">
                ...
                <div class="d-flex align-items-center gap-3 mb-2">
                  ...
                  <div class="progress mb-0  w-100" role="progressbar" aria-label="Basic example" aria-valuenow="3.1" aria-valuemin="0" aria-valuemax="100">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="/assets/images/product/5.html" alt="">
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="/assets/images/product/2.html" alt="">
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="/assets/images/product/4.html" alt="">
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="/assets/images/product/1.html" alt="">
                          </div>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex align-items-center">
                          <div class="avatar avatar-xxs rounded-circle me-2">
                            <img src="/assets/images/product/6.html" alt="">
                          </div>
