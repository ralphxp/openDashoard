// Auto-generated from components/scrollspy.html
              ...
              <div class="card-body">
                <nav id="navbar-example2" class="navbar bg-light gap-2 px-3 mb-3 rounded">
                  <a class="navbar-brand" href="javascript:void(0);">
                    <img class="visible-light" src="../../..//assets/images/logo-full.svg" alt="logo">
                    <img class="visible-dark" src="../../..//assets/images/logo-full-white.svg" alt="logo">
                  </a>
