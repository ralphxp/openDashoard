// Auto-generated from components/carousel.html
            ...
            <div id="carouselExample" class="carousel slide">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="../../..//assets/images/carousel/carousel1.webp" class="d-block w-100 rounded" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="../../..//assets/images/carousel/carousel2.webp" class="d-block w-100 rounded" alt="...">
                </div>
                <div class="carousel-item">
                  <img src="../../..//assets/images/carousel/carousel3.webp" class="d-block w-100 rounded" alt="...">
                </div>
              </div>
          ...
          <div class="col-lg-6 mb-5">
            ...
            <div id="carouselExampleIndicators" class="carousel slide">
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item">
                  <img src="../../..//assets/images/carousel/carousel4.webp" class="d-block w-100 rounded" alt="...">
                </div>
              </div>
          ...
          <div class="col-lg-6 mb-5">
            ...
            <div id="carouselExampleCaptions" class="carousel slide">
              ...
              <div class="carousel-inner">
                ...
                <div class="carousel-item">
                  <img src="../../..//assets/images/carousel/carousel5.webp" class="d-block w-100 rounded" alt="...">
                  <div class="carousel-caption d-none d-md-block">
