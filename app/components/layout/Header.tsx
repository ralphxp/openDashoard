      ...
      <div className="app-header-inner">
        <button className="app-toggler" type="button" aria-label="app toggler">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.66699 12.6668L3.66699 8.00016L7.66699 3.3335" stroke="#1C274C" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
            <path opacity="0.5" d="M12.667 12.6668L8.66699 8.00016L12.667 3.3335" stroke="#1C274C" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
        <div className="app-header-start d-none d-md-flex">
          ...
          <div className="badge-standard d-none d-lg-inline-block">
            Today New Leads
            <span className="badge bg-primary-subtle text-primary">27</span>
          </div>
        </div>
        <div className="app-header-end">
          <div className="px-lg-4 px-2 ps-0 d-flex align-items-center">
            ...
            >
              ...
              <svg className="icon-dark" width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="d-flex align-items-center gap-sm-2 gap-0 px-lg-4 px-sm-2 px-1">
            <Link href="/email/inbox" className="btn btn-icon btn-action-gray rounded-circle waves-effect waves-light position-relative">
              <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.5" d="M22 11V12.5C22 17.214 22 19.5711 20.5355 21.0355C19.0711 22.5 16.714 22.5 12 22.5C7.28595 22.5 4.92893 22.5 3.46447 21.0355C2 19.5711 2 17.214 2 12.5C2 7.78595 2 5.42893 3.46447 3.96447C4.92893 2.5 7.28595 2.5 12 2.5H13.5" stroke="var(--bs-heading-color)" strokeWidth="2" strokeLinecap="round" />
            ...
            <div className="dropdown text-end">
              ...
              <div className="dropdown-menu dropdown-menu-lg-end p-0 w-300px mt-2">
                <div className="px-3 py-3 border-bottom d-flex justify-content-between align-items-center">
                  <h6 className="mb-0">Notifications <span className="badge badge-sm rounded-pill bg-primary ms-2">9</span></h6>
