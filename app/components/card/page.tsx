// Auto-generated from components/card.html
      ...
      <div class="container-fluid">
        ...
        <div class="row mb-4">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card">
              <img src="../../..//assets/images/card/card5.webp" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card">
              <img src="../../..//assets/images/card/card4.webp" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title mb-2">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card’s content.</p>
                <a href="javascript:void(0);" class="btn btn-primary waves-effect waves-light">Go somewhere</a>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card">
              <img src="../../..//assets/images/card/card3.webp" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title mb-2">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card’s content.</p>
                <a href="javascript:void(0);" class="btn btn-primary waves-effect waves-light">Go somewhere</a>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card">
              <img src="../../..//assets/images/card/card2.webp" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title mb-2">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card’s content.</p>
                <a href="javascript:void(0);" class="btn btn-primary waves-effect waves-light">Go somewhere</a>
        ...
        <div class="row mb-4">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card">
              <img src="../../..//assets/images/card/card1.webp" class="card-img-top" alt="...">
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card’s content.</p>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="card">
                  ...
                  <img src="../../..//assets/images/card/card5.webp" class="card-img-bottom" alt="...">
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="card text-bg-dark">
                  <img src="../../..//assets/images/card/card3.webp" class="card-img" alt="...">
        ...
        <div class="row mb-4">
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="row g-0">
                <div class="col-md-4">
                  <img src="../../..//assets/images/card/card1.webp" class="img-fluid rounded-start h-100 object-fit-cover" alt="...">
                </div>
                <div class="col-md-8">
                  <div class="card-body">
                    <h5 class="card-title mb-2">Card title</h5>
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="row g-0">
                ...
                <div class="col-md-4">
                  <img src="../../..//assets/images/card/card2.webp" class="img-fluid rounded-end h-100 object-fit-cover" alt="...">
                </div>
              </div>
            </div>
          </div>
