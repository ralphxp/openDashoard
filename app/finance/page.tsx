// Auto-generated from finance.html
// Route: /finance
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xxl-3 col-xl-4">
            <div class="card overflow-hidden bg-primary ovarlay-primary-gradient border-0" style="background-image: url(/assets/images/wind.html); background-position: center; background-size: cover;">
