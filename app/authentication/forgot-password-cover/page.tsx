// Auto-generated from authentication/forgot-password-cover.html
// Route: /authentication/forgot-password-cover
      ...
      <div class="row g-0">
        ...
        <div class="col-md-6 align-self-center">
          <div class="px-3 py-5 p-sm-5 maxw-450px m-auto">
            ...
            <form action="/authentication/new-password-cover">
              <div class="mb-4">
              ...
              <div class="clearfix">
                ...
                <a href="/authentication/login-cover" class="btn btn-light waves-effect waves-light w-100"> Cancel </a>
              </div>
            </form>
          </div>
        </div>
