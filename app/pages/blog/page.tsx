// Auto-generated from pages/blog.html
// Route: /pages/blog
        ...
        <div class="row">
          ...
          <div class="col-xxl-3 col-lg-4 col-md-6 m-b30">
            <div class="card card-action action-elevate">
              <img src="../../..//assets/images/blog/blog1.webp" class="card-img-top" alt="...">
              <div class="card-body">
                ...
                <a href="/pages/blog-details" class="btn-link stretched-link">Read More</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-xxl-3 col-lg-4 col-md-6 m-b30">
            <div class="card card-action action-elevate">
              <img src="../../..//assets/images/blog/blog2.webp" class="card-img-top" alt="...">
              <div class="card-body">
                <ul class="d-flex list-inline mb-2 gap-3 flex-wrap">
                  <li class="d-flex gap-1 align-items-center">
                    <i class="icon-calendar text-primary"></i>
                ...
                <h5>
                  <a href="/pages/blog-details" class="text-dark">How to Build a Scalable CRM Dashboard for Teams and Enterprises</a>
                </h5>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting.</p>
                <a href="/pages/blog-details" class="btn-link stretched-link">Read More</a>
              </div>
          ...
          <div class="col-xxl-3 col-lg-4 col-md-6 m-b30">
            <div class="card card-action action-elevate">
              <img src="../../..//assets/images/blog/blog3.webp" class="card-img-top" alt="...">
              <div class="card-body">
                <ul class="d-flex list-inline mb-2 gap-3 flex-wrap">
                  <li class="d-flex gap-1 align-items-center">
                    <i class="icon-calendar text-primary"></i>
                ...
                <h5>
                  <a href="/pages/blog-details" class="text-dark">Designing the Perfect CRM Admin Dashboard: A Step-by-Step Guide</a>
                </h5>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting.</p>
                <a href="/pages/blog-details" class="btn-link stretched-link">Read More</a>
              </div>
          ...
          <div class="col-xxl-3 col-lg-4 col-md-6 m-b30">
            <div class="card card-action action-elevate">
              <img src="../../..//assets/images/blog/blog4.webp" class="card-img-top" alt="...">
              <div class="card-body">
                <ul class="d-flex list-inline mb-2 gap-3 flex-wrap">
                  <li class="d-flex gap-1 align-items-center">
                    <i class="icon-calendar text-primary"></i>
                ...
                <h5>
                  <a href="/pages/blog-details" class="text-dark">Dashboard Insights That Transform Customer Relationship Management</a>
                </h5>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting.</p>
                <a href="/pages/blog-details" class="btn-link stretched-link">Read More</a>
              </div>
          ...
          <div class="col-xxl-3 col-lg-4 col-md-6 m-b30">
            <div class="card card-action action-elevate">
              <img src="../../..//assets/images/blog/blog5.webp" class="card-img-top" alt="...">
              <div class="card-body">
                <ul class="d-flex list-inline mb-2 gap-3 flex-wrap">
                  <li class="d-flex gap-1 align-items-center">
                    <i class="icon-calendar text-primary"></i>
                ...
                <h5>
                  <a href="/pages/blog-details" class="text-dark">From Data Chaos to Clarity: How CRM Admin Tools Simplify Management</a>
                </h5>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting.</p>
                <a href="/pages/blog-details" class="btn-link stretched-link">Read More</a>
              </div>
          ...
          <div class="col-xxl-3 col-lg-4 col-md-6 m-b30">
            <div class="card card-action action-elevate">
              <img src="../../..//assets/images/blog/blog6.webp" class="card-img-top" alt="...">
              <div class="card-body">
                <ul class="d-flex list-inline mb-2 gap-3 flex-wrap">
                  <li class="d-flex gap-1 align-items-center">
                    <i class="icon-calendar text-primary"></i>
                ...
                <h5>
                  <a href="/pages/blog-details" class="text-dark">Top UI/UX Trends Shaping the Next Generation of CRM Dashboards</a>
                </h5>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting.</p>
                <a href="/pages/blog-details" class="btn-link stretched-link">Read More</a>
              </div>
          ...
          <div class="col-xxl-3 col-lg-4 col-md-6 m-b30">
            <div class="card card-action action-elevate">
              ...
              <div class="card-body">
                ...
                <h5>
                  <a href="/pages/blog-details" class="text-dark">Why Your Business Needs a Customizable CRM Admin</a>
                </h5>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting.</p>
                <a href="/pages/blog-details" class="btn-link stretched-link">Read More</a>
              </div>
          ...
          <div class="col-xxl-3 col-lg-4 col-md-6 m-b30">
            <div class="card card-action action-elevate">
              ...
              <div class="card-body">
                ...
                <h5>
                  <a href="/pages/blog-details" class="text-dark">The Future of CRM: AI-Powered Admin Dashboards for Smarter</a>
                </h5>
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting.</p>
                <a href="/pages/blog-details" class="btn-link stretched-link">Read More</a>
              </div>
