// Auto-generated from user-management.html
          ...
          <div class="col-xl-3 col-sm-6">
            <div class="card">
              <div class="card-header d-flex align-items-center justify-content-between border-0 pb-0">
                ...
                <div class="btn-group">
                  <button class="btn btn-action-primary btn-sm btn-icon btn-outline-light waves-effect dropdown-toggle" data-bs-toggle="dropdown">
                ...
                <table id="dt_UserList" class="table table-sm table-row-rounded display">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          <button class="btn btn-subtle-primary btn-sm btn-shadow btn-icon waves-effect dropdown-toggle" data-bs-toggle="dropdown">
